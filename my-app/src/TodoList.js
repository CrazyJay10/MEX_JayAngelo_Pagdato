    ...
    return ( 
        <div className="Todo-list">
            ...
            <div className="addTodo">
                <Link to={'/AddTodo'}><button className='addbutton'>Add Todo</button></Link>
            </div>
            ...
            {filteredList.map((item) => (
                ...
                <p className="todoStatus" ><Link to={`/DoneTodo/${item.id}`}><button disabled={item.TodoStatus==="Done"}>Done</button></Link> | <Link to={`/RemoveTodo/${item.id}`}><button className="todoRemove">Remove</button></Link></p>  
            </div>
            ))}
